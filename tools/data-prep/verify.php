    ...
    support_data_prep_write_report($options, support_data_prep_report(
        ...
        [
            ...
            'settings' => support_data_prep_public_settings([
                ...
                'accountSsoEnabled' => $settings['accountSsoEnabled'] ?? false,
                'accountBaseUrl' => $settings['accountBaseUrl'] ?? '',
                'accountClientId' => $settings['accountClientId'] ?? '',
                'accountClientSecret' => $settings['accountClientSecret'] ?? '',
                'accountRedirectUri' => $settings['accountRedirectUri'] ?? '',
                'accountPostLogoutRedirectUri' => $settings['accountPostLogoutRedirectUri'] ?? '',
                'accountScopes' => $settings['accountScopes'] ?? '',
